...
Type
  ...
  TTSTOWorkSpaceProjectGroup = Class(TObject)
  Public
    Class Function CreateWorkSpaceProjectGroup() : ITSTOWorkSpaceProjectGroup;
    Class Function CreateWorkSpaceProject() : ITSTOWorkSpaceProject;

  End;

Implementation

Uses TSTOProjectWorkSpaceImpl;

Class Function TTSTOWorkSpaceProjectGroup.CreateWorkSpaceProjectGroup() : ITSTOWorkSpaceProjectGroup;
Begin
  Result := TSTOProjectWorkSpaceImpl.TTSTOWorkSpaceProjectGroup.Create();
End;

Class Function TTSTOWorkSpaceProjectGroup.CreateWorkSpaceProject() : ITSTOWorkSpaceProject;
Begin
  Result := TSTOProjectWorkSpaceImpl.TTSTOWorkSpaceProject.Create();
End;
