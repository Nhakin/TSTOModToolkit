...
Type
  ...
  Private
    FSubVariablesImpl : ISbtpSubVariables;
...
Begin
  ...
  Result := (lXml As IXmlDocumentEx).GetDocBinding('SBTPFile', TXmlSbtpFileImpl) As IXmlSbtpFile;
End;
...
Function TXmlSbtpFileImpl._Release() : Integer;
Begin
//  If GetRefCount() = 2 Then
//  Begin
