...
uses
  ...
  HsJclIDEUtils,
  HsJvPlugin, HSJvPluginParamsForm;//, JvConsts, JvDsgnConsts;
...
var
  Repository : THsJclBorRadToolRepository;
  Installations : THsJclBorRADToolInstallations;
begin
  Result := RsProjects;
  Installations := THsJclBorRADToolInstallations.Create;
  try
    {$IFDEF BCB}
