...
type
  ...
  EHsJclBorRADException = class(EHsJclError);

  THsJclBorRADToolKind = (brDelphi, brCppBuilder, brBorlandDevStudio);
  THsJclBorRADToolEdition = (deSTD, dePRO, deCSS, deARC);
  THsJclBorRADToolPath = string;
...
const
  ...
  BorRADToolEditionIDs: array [THsJclBorRADToolEdition] of PChar =
...
type
  THsJclBorPersonality = (bpDelphi32, bpDelphi64, bpDelphiOSX32, bpBCBuilder32, bpBCBuilder64,
    bpDelphiNet32, bpDelphiNet64, bpCSBuilder32, bpCSBuilder64,
    bpVisualBasic32, bpVisualBasic64, bpDesign, bpUnknown);

  THsJclBorPersonalities = set of THsJclBorPersonality;

  THsJclBorDesigner = (bdVCL, bdCLX);

  THsJclBorDesigners = set of THsJclBorDesigner;

  THsJclBDSPlatform = (bpWin32, bpWin64, bpOSX32);

const
  HsJclBorPersonalityDescription: array [THsJclBorPersonality] of string =
   (
  ...
  HsJclBorDesignerDescription: array [THsJclBorDesigner] of string =
    (DesignerVCL, DesignerCLX);
  HsJclBorDesignerFormExtension: array [THsJclBorDesigner] of string =
    (SourceExtensionDFM, SourceExtensionXFM);

type
  THsJclBorRADToolInstallation = class;

  THsJclBorRADToolInstallationObject = class(TInterfacedObject)
  private
    FInstallation: THsJclBorRADToolInstallation;
  public
    constructor Create(AInstallation: THsJclBorRADToolInstallation);
    property Installation: THsJclBorRADToolInstallation read FInstallation;
  end;

  THsJclBorRADToolIdeTool = class(THsJclBorRADToolInstallationObject)
  private
    FKey: string;
  ...
  THsJclBorRADToolIdePackages = class(THsJclBorRADToolInstallationObject)
  private
  ...
  THsJclBorRADToolPalette = class(THsJclBorRADToolInstallationObject)
  private
    FKey: string;
  ...
  THsJclBorRADToolRepository = class(THsJclBorRADToolInstallationObject)
  private
    FIniFile: TIniFile;
    FFileName: string;
    FPages: TStringList;
  ...
  THsJclBorRADToolInstallationClass = class of THsJclBorRADToolInstallation;

  THsJclBorRADToolInstallation = class(TObject)
  private
    ...
    FDCC: THsJclDCC32;
    FDCC32: THsJclDCC32;
    FBpr2Mak: THsJclBpr2Mak;
    FMake: IJclCommandLineTool;
    FEditionStr: string;
    FEdition: THsJclBorRADToolEdition;
    FEnvironmentVariables: TStringList;
    FIdePackages: THsJclBorRADToolIdePackages;
    FIdeTools: THsJclBorRADToolIdeTool;
    FInstalledUpdatePack: Integer;
    {$IFDEF MSWINDOWS}
    FOpenHelp: THsJclBorlandOpenHelp;
    {$ENDIF MSWINDOWS}
    FPalette: THsJclBorRADToolPalette;
    FRepository: THsJclBorRADToolRepository;
    ...
    FPersonalities: THsJclBorPersonalities;
    FOutputCallback: TTextHandler;
    function GetSupportsLibSuffix: Boolean;
    function GetBCC: THsJclBCC32;
    function GetBCC32: THsJclBCC32;
    function GetDCC: THsJclDCC32;
    function GetDCC32: THsJclDCC32;
    function GetBpr2Mak: THsJclBpr2Mak;
    ...
    function GetIdePackages: THsJclBorRADToolIdePackages;
    function GetIsTurboExplorer: Boolean;
    function GetLatestUpdatePack: Integer;
    function GetPalette: THsJclBorRADToolPalette;
    function GetRepository: THsJclBorRADToolRepository;
    ...
    procedure SetBCC(const Value: THsJclBCC32);
    procedure SetDCC(const Value: THsJclDCC32);
  protected
    ...
    function GetDCPOutputPath(APlatform: THsJclBDSPlatform): string; virtual;
    function GetBPLOutputPath(APlatform: THsJclBDSPlatform): string; virtual;
    function GetEnvironmentVariables: TStrings; virtual;
    function GetVclIncludeDir(APlatform: THsJclBDSPlatform): string; virtual;
    ...
    function GetDebugDCUPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; virtual;
    function GetRawDebugDCUPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; virtual;
    procedure SetRawDebugDCUPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath); virtual;
    function GetLibrarySearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; virtual;
    function GetRawLibrarySearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; virtual;
    procedure SetRawLibrarySearchPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath); virtual;
    function GetLibraryBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; virtual;
    function GetRawLibraryBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; virtual;
    procedure SetRawLibraryBrowsingPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath); virtual;

    function GetLibFolderName(APlatform: THsJclBDSPlatform): string; virtual;
    function GetObjFolderName(APlatform: THsJclBDSPlatform): string; virtual;
    function GetLibDebugFolderName(APlatform: THsJclBDSPlatform): string; virtual;

    function GetValid: Boolean; virtual;
    function GetLongPathBug: Boolean;
    function GetCompilerSettingsFormat: THsJclCompilerSettingsFormat;
    function GetSupportsNoConfig: Boolean;
    function GetSupportsPlatform: Boolean;

    procedure CheckPlatform(APlatform: THsJclBDSPlatform);
    procedure CheckCBuilderPlatform(APlatform: THsJclBDSPlatform);
  public
    constructor Create(const AConfigDataLocation: string; ARootKey: Cardinal = 0); virtual;

    destructor Destroy; override;
    class procedure ExtractPaths(const Path: THsJclBorRADToolPath; List: TStrings);
    ...
    class function RadToolKind: THsJclBorRADToolKind; virtual;
    {class} function RadToolName: string; virtual;
    function AnyInstanceRunning: Boolean;
    function AddToDebugDCUPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function AddToLibrarySearchPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function AddToLibraryBrowsingPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    ...
    function RemoveFromDebugDCUPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function RemoveFromLibrarySearchPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function RemoveFromLibraryBrowsingPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function SubstitutePath(const Path: string): string;
    function SupportsVisualCLX: Boolean;
    function SupportsVCL: Boolean;
    property LibFolderName[APlatform: THsJclBDSPlatform]: string read GetLibFolderName;
    property ObjFolderName[APlatform: THsJclBDSPlatform]: string read GetObjFolderName;
    property LibDebugFolderName[APlatform: THsJclBDSPlatform]: string read GetLibDebugFolderName;
    // Command line tools
    property CommandLineTools: TCommandLineTools read FCommandLineTools;
    property BCC: THsJclBCC32 read GetBCC write SetBCC;
    property BCC32: THsJclBCC32 read GetBCC32;
    property DCC: THsJclDCC32 read GetDCC write SetDCC;
    property DCC32: THsJclDCC32 read GetDCC32;
    property Bpr2Mak: THsJclBpr2Mak read GetBpr2Mak;
    property Make: IJclCommandLineTool read GetMake;
    // Paths
    property BinFolderName: string read FBinFolderName;
    property BPLOutputPath[APlatform: THsJclBDSPlatform]: string read GetBPLOutputPath;
    property DebugDCUPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetDebugDCUPath {$IFDEF KEEP_DEPRECATED}write SetRawDebugDCUPath{$ENDIF};
    property RawDebugDCUPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetRawDebugDCUPath write SetRawDebugDCUPath;
    property DCPOutputPath[APlatform: THsJclBDSPlatform]: string read GetDCPOutputPath;
    ...
    property Edition: THsJclBorRADToolEdition read FEdition;
    property EditionAsText: string read GetEditionAsText;
    property EnvironmentVariables: TStrings read GetEnvironmentVariables;
    property IdePackages: THsJclBorRADToolIdePackages read GetIdePackages;
    property IdeTools: THsJclBorRADToolIdeTool read FIdeTools;
    ...
    property LibrarySearchPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetLibrarySearchPath {$IFDEF KEEP_DEPRECATED}write SetRawLibrarySearchPath{$ENDIF};
    property RawLibrarySearchPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetRawLibrarySearchPath write SetRawLibrarySearchPath;
    property LibraryBrowsingPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetLibraryBrowsingPath {$IFDEF KEEP_DEPRECATED}write SetRawLibraryBrowsingPath{$ENDIF};
    property RawLibraryBrowsingPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetRawLibraryBrowsingPath write SetRawLibraryBrowsingPath;
    {$IFDEF MSWINDOWS}
    property OpenHelp: THsJclBorlandOpenHelp read FOpenHelp;
    {$ENDIF MSWINDOWS}
    ...
    property Palette: THsJclBorRADToolPalette read GetPalette;
    property Repository: THsJclBorRADToolRepository read GetRepository;
    property RootDir: string read FRootDir;
    property UpdateNeeded: Boolean read GetUpdateNeeded;
    property Valid: Boolean read GetValid;
    property VclIncludeDir[APlatform: THsJclBDSPlatform]: string read GetVclIncludeDir;
    ...
    property Personalities: THsJclBorPersonalities read FPersonalities;
    ...
    property CompilerSettingsFormat: THsJclCompilerSettingsFormat read GetCompilerSettingsFormat;
    property SupportsNoConfig: Boolean read GetSupportsNoConfig;
    property SupportsPlatform: Boolean read GetSupportsPlatform;
  end;

  THsJclBCBInstallation = class(THsJclBorRADToolInstallation)
  protected
  ...
  {$IFDEF MSWINDOWS}
  THsJclBDSInstallation = class(THsJclBorRADToolInstallation)
  private
    FDualPackageInstallation: Boolean;
    FHelp2Manager: THsJclHelp2Manager;
    FDCCIL: THsJclDCCIL;
    FDCC64: THsJclDCC64;
    FDCCOSX32: THsJclDCCOSX32;
    FBCC64: THsJclBCC64;
    FPdbCreate: Boolean;
    procedure SetDualPackageInstallation(const Value: Boolean);
    function GetCppPathsKeyName: string;
    function GetCppBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
    function GetRawCppBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
    function GetCppSearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
    function GetRawCppSearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
    function GetCppLibraryPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
    function GetRawCppLibraryPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
    function GetCppIncludePath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
    function GetRawCppIncludePath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
    procedure SetRawCppBrowsingPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
    procedure SetRawCppSearchPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
    procedure SetRawCppLibraryPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
    procedure SetRawCppIncludePath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
    function GetMaxDelphiCLRVersion: string;
    function GetDCC64: THsJclDCC64;
    function GetDCCOSX32: THsJclDCCOSX32;
    function GetDCCIL: THsJclDCCIL;
    function GetBCC64: THsJclBCC64;

    function GetMsBuildEnvOptionsFileName: string;
    function GetMsBuildEnvironmentFileName: string;
    function GetMsBuildEnvOption(const OptionName: string; APlatform: THsJclBDSPlatform; Raw: Boolean): string;
    procedure SetMsBuildEnvOption(const OptionName, Value: string; APlatform: THsJclBDSPlatform);
    function GetBDSPlatformStr(APlatform: THsJclBDSPlatform): string;
    class procedure InterpretSetVariable(const Line: string; Variables: TStrings);
  protected
    function GetDCPOutputPath(APlatform: THsJclBDSPlatform): string; override;
    function GetBPLOutputPath(APlatform: THsJclBDSPlatform): string; override;
    function GetEnvironmentVariables: TStrings; override;
    ...
    function GetVclIncludeDir(APlatform: THsJclBDSPlatform): string; override;
    function GetName: string; override;
    procedure SetOutputCallback(const Value: TTextHandler); override;
    function GetLibDebugFolderName(APlatform: THsJclBDSPlatform): string; override;
    function GetLibFolderName(APlatform: THsJclBDSPlatform): string; override;

    function GetDebugDCUPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; override;
    function GetRawDebugDCUPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; override;
    procedure SetRawDebugDCUPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath); override;
    function GetLibrarySearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; override;
    function GetRawLibrarySearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; override;
    procedure SetRawLibrarySearchPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath); override;
    function GetLibraryBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; override;
    function GetRawLibraryBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath; override;
    procedure SetRawLibraryBrowsingPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath); override;
  ...
  public
    ...
    function AddToCppSearchPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function AddToCppBrowsingPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function AddToCppLibraryPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function AddToCppIncludePath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function RemoveFromCppSearchPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function RemoveFromCppBrowsingPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function RemoveFromCppLibraryPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
    function RemoveFromCppIncludePath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;

    property CppSearchPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetCppSearchPath {$IFDEF KEEP_DEPRECATED}write SetRawCppSearchPath{$ENDIF};
    property RawCppSearchPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetRawCppSearchPath write SetRawCppSearchPath;
    property CppBrowsingPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetCppBrowsingPath {$IFDEF KEEP_DEPRECATED}write SetRawCppBrowsingPath{$ENDIF};
    property RawCppBrowsingPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetRawCppBrowsingPath write SetRawCppBrowsingPath;
    // Only exists in BDS 5 and upper
    property CppLibraryPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetCppLibraryPath {$IFDEF KEEP_DEPRECATED}write SetRawCppLibraryPath{$ENDIF};
    property RawCppLibraryPath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetRawCppLibraryPath write SetRawCppLibraryPath;
    property CppIncludePath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetCppIncludePath {$IFDEF KEEP_DEPRECATED}write SetRawCppIncludePath{$ENDIF};
    property RawCppIncludePath[APlatform: THsJclBDSPlatform]: THsJclBorRADToolPath read GetRawCppIncludePath write SetRawCppIncludePath;
    ...
    function CompileDelphiDotNetProject(const ProjectName, OutputDir: string; PEFormat: THsJclBDSPlatform = bpWin32;
    ...
    property Help2Manager: THsJclHelp2Manager read FHelp2Manager;
    property DCC64: THsJclDCC64 read GetDCC64;
    property DCCOSX32: THsJclDCCOSX32 read GetDCCOSX32;
    property BCC64: THsJclBCC64 read GetBCC64;
    property DCCIL: THsJclDCCIL read GetDCCIL;
  ...
  TTraverseMethod = function(Installation: THsJclBorRADToolInstallation): Boolean of object;

  THsJclBorRADToolInstallations = class(TObject)
  private
    FList: TObjectList;
    function GetBDSInstallationFromVersion(VersionNumber: Integer): THsJclBorRADToolInstallation;
    function GetBDSVersionInstalled(VersionNumber: Integer): Boolean;
    function GetCount: Integer;
    function GetInstallations(Index: Integer): THsJclBorRADToolInstallation;
    ...
    function GetBCBInstallationFromVersion(VersionNumber: Integer): THsJclBorRADToolInstallation;
    function GetDelphiInstallationFromVersion(VersionNumber: Integer): THsJclBorRADToolInstallation;
  protected
  ...
  public
    ...
    property Count: Integer read GetCount;
    property Installations[Index: Integer]: THsJclBorRADToolInstallation read GetInstallations; default;
    property BCBInstallationFromVersion[VersionNumber: Integer]: THsJclBorRADToolInstallation
      read GetBCBInstallationFromVersion;
    property DelphiInstallationFromVersion[VersionNumber: Integer]: THsJclBorRADToolInstallation
      read GetDelphiInstallationFromVersion;
    property BDSInstallationFromVersion[VersionNumber: Integer]: THsJclBorRADToolInstallation
...
//=== { THsJclBorRADToolInstallationObject } ===================================

constructor THsJclBorRADToolInstallationObject.Create(AInstallation: THsJclBorRADToolInstallation);
begin
  FInstallation := AInstallation;
end;

//== { THsJclBorRADToolIdeTool } ===============================================

constructor THsJclBorRADToolIdeTool.Create(AInstallation: THsJclBorRADToolInstallation);
begin
  inherited Create(AInstallation);
  FKey := TransferKeyName;
end;

procedure THsJclBorRADToolIdeTool.CheckIndex(Index: Integer);
begin
  if (Index < 0) or (Index >= Count) then
    raise EJclError.CreateRes(@RsEIndexOufOfRange);
end;

function THsJclBorRADToolIdeTool.GetCount: Integer;
begin
  Result := Installation.ConfigData.ReadInteger(Key, TransferCountValueName, 0);
end;

function THsJclBorRADToolIdeTool.GetParameters(Index: Integer): string;
begin
  CheckIndex(Index);
  Result := Installation.ConfigData.ReadString(Key, Format(TransferParamsValueName, [Index]), '');
end;

function THsJclBorRADToolIdeTool.GetPath(Index: Integer): string;
begin
  CheckIndex(Index);
  Result := Installation.ConfigData.ReadString(Key, Format(TransferPathValueName, [Index]), '');
end;

function THsJclBorRADToolIdeTool.GetTitle(Index: Integer): string;
begin
  CheckIndex(Index);
  Result := Installation.ConfigData.ReadString(Key, Format(TransferTitleValueName, [Index]), '');
end;

function THsJclBorRADToolIdeTool.GetWorkingDir(Index: Integer): string;
begin
  CheckIndex(Index);
  Result := Installation.ConfigData.ReadString(Key, Format(TransferWorkDirValueName, [Index]), '');
end;

function THsJclBorRADToolIdeTool.IndexOfPath(const Value: string): Integer;
var
  I: Integer;
begin
  Result := -1;
...
function THsJclBorRADToolIdeTool.IndexOfTitle(const Value: string): Integer;
var
  I: Integer;
begin
  Result := -1;
...
procedure THsJclBorRADToolIdeTool.RemoveIndex(const Index: Integer);
var
  I: Integer;
begin
...
procedure THsJclBorRADToolIdeTool.SetCount(const Value: Integer);
begin
  if Value > Count then
    Installation.ConfigData.WriteInteger(Key, TransferCountValueName, Value);
end;

procedure THsJclBorRADToolIdeTool.SetParameters(Index: Integer; const Value: string);
begin
  CheckIndex(Index);
  Installation.ConfigData.WriteString(Key, Format(TransferParamsValueName, [Index]), Value);
end;

procedure THsJclBorRADToolIdeTool.SetPath(Index: Integer; const Value: string);
begin
  CheckIndex(Index);
  Installation.ConfigData.WriteString(Key, Format(TransferPathValueName, [Index]), Value);
end;

procedure THsJclBorRADToolIdeTool.SetTitle(Index: Integer; const Value: string);
begin
  CheckIndex(Index);
  Installation.ConfigData.WriteString(Key, Format(TransferTitleValueName, [Index]), Value);
end;

procedure THsJclBorRADToolIdeTool.SetWorkingDir(Index: Integer; const Value: string);
begin
  CheckIndex(Index);
  Installation.ConfigData.WriteString(Key, Format(TransferWorkDirValueName, [Index]), Value);
end;

//=== { THsJclBorRADToolIdePackages } ==========================================

constructor THsJclBorRADToolIdePackages.Create(AInstallation: THsJclBorRADToolInstallation);
begin
  inherited Create(AInstallation);
...
destructor THsJclBorRADToolIdePackages.Destroy;
begin
...
function THsJclBorRADToolIdePackages.AddPackage(const FileName, Description: string): Boolean;
begin
  Result := True;
...
function THsJclBorRADToolIdePackages.AddExpert(const FileName, Description: string): Boolean;
begin
  Result := True;
  RemoveDisabled(FileName);
...
function THsJclBorRADToolIdePackages.AddIDEPackage(const FileName, Description: string): Boolean;
begin
  Result := True;
  RemoveDisabled(FileName);
...
function THsJclBorRADToolIdePackages.GetCount: Integer;
begin
  Result := FKnownPackages.Count;
end;

function THsJclBorRADToolIdePackages.GetExpertCount: Integer;
begin
  Result := FExperts.Count;
end;

function THsJclBorRADToolIdePackages.GetExpertDescriptions(Index: Integer): string;
begin
  Result := FExperts.Names[Index];
end;

function THsJclBorRADToolIdePackages.GetExpertFileNames(Index: Integer): string;
begin
  Result := PackageEntryToFileName(FExperts.Values[FExperts.Names[Index]]);
end;

function THsJclBorRADToolIdePackages.GetIDECount: Integer;
begin
  Result := FKnownIDEPackages.Count;
end;

function THsJclBorRADToolIdePackages.GetPackageDescriptions(Index: Integer): string;
begin
  Result := FKnownPackages.Values[FKnownPackages.Names[Index]];
end;

function THsJclBorRADToolIdePackages.GetIDEPackageDescriptions(Index: Integer): string;
begin
  Result := FKnownPackages.Values[FKnownIDEPackages.Names[Index]];
end;

function THsJclBorRADToolIdePackages.GetPackageDisabled(Index: Integer): Boolean;
begin
  Result := Boolean(FKnownPackages.Objects[Index]);
end;

function THsJclBorRADToolIdePackages.GetPackageFileNames(Index: Integer): string;
begin
  Result := PackageEntryToFileName(FKnownPackages.Names[Index]);
end;

function THsJclBorRADToolIdePackages.GetIDEPackageFileNames(Index: Integer): string;
begin
  Result := PackageEntryToFileName(FKnownIDEPackages.Names[Index]);
end;

function THsJclBorRADToolIdePackages.PackageEntryToFileName(const Entry: string): string;
begin
  Result := Installation.SubstitutePath(Entry);
end;

procedure THsJclBorRADToolIdePackages.ReadPackages;
var
  I: Integer;
...
procedure THsJclBorRADToolIdePackages.RemoveDisabled(const FileName: string);
var
  I: Integer;
begin
...
function THsJclBorRADToolIdePackages.RemoveExpert(const FileName: string): Boolean;
var
  I: Integer;
...
function THsJclBorRADToolIdePackages.RemovePackage(const FileName: string): Boolean;
var
  I: Integer;
...
function THsJclBorRADToolIdePackages.RemoveIDEPackage(const FileName: string): Boolean;
var
  I: Integer;
...
//=== { THsJclBorRADToolPalette } ==============================================

constructor THsJclBorRADToolPalette.Create(AInstallation: THsJclBorRADToolInstallation);
begin
  inherited Create(AInstallation);
  FKey := PaletteKeyName;
...
destructor THsJclBorRADToolPalette.Destroy;
begin
  FreeAndNil(FTabNames);
  inherited Destroy;
end;

procedure THsJclBorRADToolPalette.ComponentsOnTabToStrings(Index: Integer; Strings: TStrings;
...
function THsJclBorRADToolPalette.DeleteTabName(const TabName: string): Boolean;
var
  I: Integer;
begin
...
function THsJclBorRADToolPalette.GetComponentsOnTab(Index: Integer): string;
begin
  Result := Installation.ConfigData.ReadString(Key, FTabNames[Index], '');
end;

function THsJclBorRADToolPalette.GetHiddenComponentsOnTab(Index: Integer): string;
begin
  Result := Installation.ConfigData.ReadString(Key, FTabNames[Index] + PaletteHiddenTag, '');
end;

function THsJclBorRADToolPalette.GetTabNameCount: Integer;
begin
  Result := FTabNames.Count;
end;

function THsJclBorRADToolPalette.GetTabNames(Index: Integer): string;
begin
  Result := FTabNames[Index];
end;

procedure THsJclBorRADToolPalette.ReadTabNames;
var
  TempList: TStringList;
  I: Integer;
  S: string;
...
function THsJclBorRADToolPalette.TabNameExists(const TabName: string): Boolean;
begin
  Result := FTabNames.IndexOf(TabName) <> -1;
end;

//=== { THsJclBorRADToolRepository } ===========================================

constructor THsJclBorRADToolRepository.Create(AInstallation: THsJclBorRADToolInstallation);
begin
  inherited Create(AInstallation);
...
destructor THsJclBorRADToolRepository.Destroy;
begin
  FreeAndNil(FPages);
  FreeAndNil(FIniFile);
  inherited Destroy;
...
procedure THsJclBorRADToolRepository.AddObject(const FileName, ObjectType, PageName, ObjectName,
...
procedure THsJclBorRADToolRepository.CloseIniFile;
begin
  FreeAndNil(FIniFile);
end;

function THsJclBorRADToolRepository.FindPage(const Name: string; OptionalIndex: Integer): string;
var
  I: Integer;
begin
...
function THsJclBorRADToolRepository.GetIniFile: TIniFile;
begin
...
function THsJclBorRADToolRepository.GetPages: TStrings;
begin
  Result := FPages;
end;

procedure THsJclBorRADToolRepository.RemoveObjects(const PartialPath, FileName, ObjectType: string);
var
...
//=== { THsJclBorRADToolInstallation } =========================================

constructor THsJclBorRADToolInstallation.Create(const AConfigDataLocation: string; ARootKey: Cardinal);
{$IFDEF MSWINDOWS}
var
  HelpPrefix: string;
{$ENDIF MSWINDOWS}
begin
  ...
  ReadInformation;
  FIdeTools := THsJclBorRADToolIdeTool.Create(Self);
  {$IFDEF MSWINDOWS}
  case RadToolKind of
    brDelphi:
  ...
  FOpenHelp := THsJclBorlandOpenHelp.Create(RootDir, HelpPrefix);
  {$ENDIF ~MSWINDOWS}
  FMapCreate := False;
  {$IFDEF MSWINDOWS}
  FJdbgCreate := False;
...
destructor THsJclBorRADToolInstallation.Destroy;
begin
...
function THsJclBorRADToolInstallation.AddToDebugDCUPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawDebugDCUPath: THsJclBorRADToolPath;
begin
...
function THsJclBorRADToolInstallation.AddToLibrarySearchPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawLibraryPath: THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBorRADToolInstallation.AddToLibraryBrowsingPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawLibraryPath: THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBorRADToolInstallation.AnyInstanceRunning: Boolean;
var
...
class procedure THsJclBorRADToolInstallation.ExtractPaths(const Path: THsJclBorRADToolPath; List: TStrings);
begin
  StrToStrings(Path, PathSep, List);
end;

procedure THsJclBorRADToolInstallation.CheckCBuilderPlatform(APlatform: THsJclBDSPlatform);
begin
  if ((APlatform = bpWin32) and not (bpBCBuilder32 in Personalities)) or
    ...
    raise EHsJclBorRADException.CreateRes(@RsEPlatformNotValid);
end;

procedure THsJclBorRADToolInstallation.CheckPlatform(APlatform: THsJclBDSPlatform);
begin
...
function THsJclBorRADToolInstallation.CompileBCBPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
...
begin
  ...
  if not IsBCBPackage(PackageName) then
    raise EHsJclBorRADException.CreateResFmt(@RsENotABCBPackage, [PackageName]);
...
function THsJclBorRADToolInstallation.CompileBCBProject(const ProjectName, OutputDir, DcpSearchPath: string): Boolean;
var
  SaveDir, PackagePath, MakeFileName: string;
begin
  ...
  if not IsBCBProject(ProjectName) then
    raise EHsJclBorRADException.CreateResFmt(@RsENotADelphiProject, [ProjectName]);
...
function THsJclBorRADToolInstallation.CompileDelphiPackage(const PackageName,
...
begin
  ...
  if not IsDelphiPackage(PackageName) then
    raise EHsJclBorRADException.CreateResFmt(@RsENotADelphiPackage, [PackageName]);
...
function THsJclBorRADToolInstallation.CompileDelphiProject(const ProjectName,
...
function THsJclBorRADToolInstallation.CompilePackage(const PackageName, BPLPath,
...
begin
  ...
  if SameText(PackageExtension, SourceExtensionDelphiPackage) then
    ...
    raise EHsJclBorRADException.CreateResFmt(@RsEUnknownPackageExtension, [PackageExtension]);
end;

function THsJclBorRADToolInstallation.CompileProject(const ProjectName,
  OutputDir, DcpSearchPath: string): Boolean;
var
...
begin
  ...
  if SameText(ProjectExtension, SourceExtensionDelphiProject) then
    ...
    raise EHsJclBorRADException.CreateResFmt(@RsEUnknownProjectExtension, [ProjectExtension]);
end;

function THsJclBorRADToolInstallation.FindFolderInPath(Folder: string; List: TStrings): Integer;
var
  I: Integer;
begin
  Result := -1;
...
function THsJclBorRADToolInstallation.GetBPLOutputPath(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
  Result := SubstitutePath(ConfigData.ReadString(LibraryKeyName, LibraryBPLOutputValueName, ''));
end;

function THsJclBorRADToolInstallation.GetBpr2Mak: THsJclBpr2Mak;
begin
  if not Assigned(FBpr2Mak) then
  begin
    if not (clProj2Mak in CommandLineTools) then
      raise EHsJclBorRADException.CreateResFmt(@RsENotFound, [Bpr2MakExeName]);
    FBpr2Mak := THsJclBpr2Mak.Create(BinFolderName, LongPathBug, CompilerSettingsFormat);
  end;
  Result := FBpr2Mak;
end;

function THsJclBorRADToolInstallation.GetBCC: THsJclBCC32;
begin
...
function THsJclBorRADToolInstallation.GetBCC32: THsJclBCC32;
begin
  if not Assigned(FBCC32) then
  begin
    if not (clBcc32 in CommandLineTools) then
      raise EHsJclBorRADException.CreateResFmt(@RsENotFound, [Bcc32ExeName]);
    FBCC32 := THsJclBCC32.Create(BinFolderName, LongPathBug, CompilerSettingsFormat);
  end;
  Result := FBCC32;
end;

function THsJclBorRADToolInstallation.GetCommonProjectsDir: string;
begin
  Result := DefaultProjectsDir;
end;

function THsJclBorRADToolInstallation.GetCompilerSettingsFormat: THsJclCompilerSettingsFormat;
begin
...
function THsJclBorRADToolInstallation.GetDCC: THsJclDCC32;
begin
...
function THsJclBorRADToolInstallation.GetDCC32: THsJclDCC32;
begin
  if not Assigned(FDCC32) then
  begin
    if not (clDcc32 in CommandLineTools) then
      raise EHsJclBorRADException.CreateResFmt(@RsENotFound, [Dcc32ExeName]);
    FDCC32 := THsJclDCC32.Create(BinFolderName, LongPathBug, DCCVersion, CompilerSettingsFormat,
...
function THsJclBorRADToolInstallation.GetDCPOutputPath(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
  Result := SubstitutePath(ConfigData.ReadString(LibraryKeyName, LibraryDCPOutputValueName, ''));
end;

function THsJclBorRADToolInstallation.GetDebugDCUPath(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
  Result := ConfigData.ReadString(DebuggingKeyName, DebugDCUPathValueName, '');
end;

function THsJclBorRADToolInstallation.GetDefaultProjectsDir: string;
begin
...
function THsJclBorRADToolInstallation.GetDescription: THsJclBorRADToolPath;
begin
...
function THsJclBorRADToolInstallation.GetEditionAsText: string;
begin
  Result := FEditionStr;
...
function THsJclBorRADToolInstallation.GetDefaultBDSCommonDir: string;
const
...
function THsJclBorRADToolInstallation.GetEnvironmentVariables: TStrings;
var
...
function THsJclBorRADToolInstallation.GetGlobals: TStrings;
begin
  Result := FGlobals;
end;

function THsJclBorRADToolInstallation.GetIdeExeFileName: string;
begin
  Result := Globals.Values['App'];
end;

function THsJclBorRADToolInstallation.GetIdeExeBuildNumber: string;
begin
  Result := VersionFixedFileInfoString(IdeExeFileName, vfFull);
end;

function THsJclBorRADToolInstallation.GetIdePackages: THsJclBorRADToolIdePackages;
begin
  if not Assigned(FIdePackages) then
    FIdePackages := THsJclBorRADToolIdePackages.Create(Self);
  Result := FIdePackages;
end;

function THsJclBorRADToolInstallation.GetIsTurboExplorer: Boolean;
begin
  Result := (RadToolKind = brBorlandDevStudio) and (VersionNumber = 4) and not (clDcc32 in CommandLineTools);
end;

function THsJclBorRADToolInstallation.GetLatestUpdatePack: Integer;
begin
  Result := GetLatestUpdatePackForVersion(VersionNumber);
end;

class function THsJclBorRADToolInstallation.GetLatestUpdatePackForVersion(Version: Integer): Integer;
begin
  {$IFDEF MSWINDOWS}
...
function THsJclBorRADToolInstallation.GetLibrarySearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
  Result := ConfigData.ReadString(LibraryKeyName, LibrarySearchPathValueName, '');
end;

function THsJclBorRADToolInstallation.GetLongPathBug: Boolean;
begin
  Result := (RadToolKind in [brDelphi, brCppBuilder]) or (VersionNumber < 3);
end;

function THsJclBorRADToolInstallation.GetMake: IJclCommandLineTool;
begin
  if not Assigned(FMake) then
  begin
    if not (clMake in CommandLineTools) then
      raise EHsJclBorRADException.CreateResFmt(@RsENotFound, [MakeExeName]);
    FMake := THsJclBorlandMake.Create(BinFolderName, LongPathBug, CompilerSettingsFormat);
...
function THsJclBorRADToolInstallation.GetLibDebugFolderName(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
  Result := LibFolderName[APlatform] + PathAddSeparator('debug');
end;

function THsJclBorRADToolInstallation.GetLibFolderName(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
  Result := PathAddSeparator(RootDir) + PathAddSeparator('lib');
end;

function THsJclBorRADToolInstallation.GetLibraryBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
  Result := ConfigData.ReadString(LibraryKeyName, LibraryBrowsingPathValueName, '');
end;

function THsJclBorRADToolInstallation.GetName: string;
begin
  Result := Format('%s %d', [RADToolName, IDEVersionNumber]);
end;

function THsJclBorRADToolInstallation.GetObjFolderName(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
...
function THsJclBorRADToolInstallation.GetIDEPackageVersionNumberStr: string;
var
  Value: Integer;
begin
...
function THsJclBorRADToolInstallation.GetPackageVersionNumberStr: string;
var
  Value: Integer;
begin
...
function THsJclBorRADToolInstallation.GetPalette: THsJclBorRADToolPalette;
begin
  if not Assigned(FPalette) then
    FPalette := THsJclBorRADToolPalette.Create(Self);
  Result := FPalette;
end;

function THsJclBorRADToolInstallation.GetRawDebugDCUPath(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
  Result := GetDebugDCUPath(APlatform);
end;

function THsJclBorRADToolInstallation.GetRawLibrarySearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
  Result := GetLibrarySearchPath(APlatform);
end;

function THsJclBorRADToolInstallation.GetRawLibraryBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
  Result := GetLibraryBrowsingPath(APlatform);
end;

function THsJclBorRADToolInstallation.GetRepository: THsJclBorRADToolRepository;
begin
  if not Assigned(FRepository) then
    FRepository := THsJclBorRADToolRepository.Create(Self);
  Result := FRepository;
end;

function THsJclBorRADToolInstallation.GetSupportsLibSuffix: Boolean;
begin
  Result := (RadToolKind = brBorlandDevStudio) or (VersionNumber >= 6);
end;

function THsJclBorRADToolInstallation.GetSupportsNoConfig: Boolean;
begin
  Result := (RadToolKind = brBorlandDevStudio) and (VersionNumber >= 4);
end;

function THsJclBorRADToolInstallation.GetSupportsPlatform: Boolean;
begin
  Result := (RadToolKind = brBorlandDevStudio) and (VersionNumber >= 9);
end;

function THsJclBorRADToolInstallation.GetUpdateNeeded: Boolean;
begin
  Result := InstalledUpdatePack < LatestUpdatePack;
end;

function THsJclBorRADToolInstallation.GetValid: Boolean;
begin
  Result := (ConfigData.FileName <> '') and (RootDir <> '') and FileExists(IdeExeFileName);
end;

function THsJclBorRADToolInstallation.GetVclIncludeDir(APlatform: THsJclBDSPlatform): string;
begin
...
function THsJclBorRADToolInstallation.InstallBCBExpert(const ProjectName, OutputDir, DcpSearchPath: string): Boolean;
var
...
function THsJclBorRADToolInstallation.InstallBCBIdePackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  RunOnly: Boolean;
  Unused, Description: string;
begin
  ...
  if RunOnly then
    raise EHsJclBorRADException.CreateResFmt(@RsECannotInstallRunOnly, [PackageName]);
...
function THsJclBorRADToolInstallation.InstallBCBPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  RunOnly: Boolean;
  Unused, Description: string;
begin
...
function THsJclBorRADToolInstallation.InstallDelphiExpert(const ProjectName, OutputDir, DcpSearchPath: string): Boolean;
var
  BaseName: string;
begin
  OutputString(Format(LoadResString(@RsExpertInstallationStarted), [ProjectName]));
...
function THsJclBorRADToolInstallation.InstallDelphiIdePackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  RunOnly: Boolean;
  Unused, Description: string;
begin
...
function THsJclBorRADToolInstallation.InstallDelphiPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  RunOnly: Boolean;
  Unused, Description: string;
begin
...
function THsJclBorRADToolInstallation.InstallExpert(const ProjectName, OutputDir, DcpSearchPath: string): Boolean;
var
  ProjectExtension: string;
begin
  ProjectExtension := ExtractFileExt(ProjectName);
...
function THsJclBorRADToolInstallation.InstallIDEPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  PackageExtension: string;
begin
  PackageExtension := ExtractFileExt(PackageName);
  ...
  if SameText(PackageExtension, SourceExtensionDelphiPackage) then
    ...
    raise EHsJclBorRADException.CreateResFmt(@RsEUnknownIdePackageExtension, [PackageExtension]);
end;

function THsJclBorRADToolInstallation.InstallPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  PackageExtension: string;
begin
  PackageExtension := ExtractFileExt(PackageName);
...
function THsJclBorRADToolInstallation.ProcessMapFile(const BinaryFileName: string): Boolean;
{$IFDEF MSWINDOWS}
var
...
function THsJclBorRADToolInstallation.OutputFileDelete(const FileName: string): Boolean;
begin
...
procedure THsJclBorRADToolInstallation.OutputString(const AText: string);
begin
  if Assigned(FOutputCallback) then
    OutputCallback(AText);
end;

class function THsJclBorRADToolInstallation.PackageSourceFileExtension: string;
begin
  {$IFDEF MSWINDOWS}
  raise EAbstractError.CreateResFmt(@SAbstractError, ['']); // BCB doesn't support abstract keyword
  {$ELSE MSWINDOWS}
...
class function THsJclBorRADToolInstallation.ProjectSourceFileExtension: string;
begin
  {$IFDEF MSWINDOWS}
  raise EAbstractError.CreateResFmt(@SAbstractError, ['']); // BCB doesn't support abstract keyword
  {$ELSE MSWINDOWS}
...
class function THsJclBorRADToolInstallation.RADToolKind: THsJclBorRADToolKind;
begin
  {$IFDEF MSWINDOWS}
  raise EAbstractError.CreateResFmt(@SAbstractError, ['']); // BCB doesn't support abstract keyword
  {$ELSE MSWINDOWS}
...
{class }function THsJclBorRADToolInstallation.RADToolName: string;
begin
  {$IFDEF MSWINDOWS}
  raise EAbstractError.CreateResFmt(@SAbstractError, ['']); // BCB doesn't support abstract keyword
  {$ELSE MSWINDOWS}
...
procedure THsJclBorRADToolInstallation.ReadInformation;
...
function THsJclBorRADToolInstallation.RegisterExpert(const ProjectName, OutputDir, Description: string): Boolean;
begin
  Result := RegisterExpert(BinaryFileName(OutputDir, ProjectName), Description);
end;

function THsJclBorRADToolInstallation.RegisterExpert(const BinaryFileName, Description: string): Boolean;
var
...
function THsJclBorRADToolInstallation.RegisterIDEPackage(const PackageName, BPLPath, Description: string): Boolean;
begin
  Result := RegisterIDEPackage(BinaryFileName(BPLPath, PackageName), Description);
end;

function THsJclBorRADToolInstallation.RegisterIDEPackage(const BinaryFileName, Description: string): Boolean;
var
  InternalDescription: string;
begin
...
function THsJclBorRADToolInstallation.RegisterPackage(const PackageName, BPLPath, Description: string): Boolean;
begin
  Result := RegisterPackage(BinaryFileName(BPLPath, PackageName), Description);
end;

function THsJclBorRADToolInstallation.RegisterPackage(const BinaryFileName, Description: string): Boolean;
var
  InternalDescription: string;
begin
...
function THsJclBorRADToolInstallation.RemoveFromDebugDCUPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawDebugDCUPath: THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBorRADToolInstallation.RemoveFromLibrarySearchPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawLibraryPath: THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBorRADToolInstallation.RemoveFromLibraryBrowsingPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawLibraryPath: THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBorRADToolInstallation.RemoveFromPath(var Path: string; const ItemsToRemove: string): Boolean;
var
...
procedure THsJclBorRADToolInstallation.SetBCC(const Value: THsJclBCC32);
begin
  FBCC := Value;
end;

procedure THsJclBorRADToolInstallation.SetDCC(const Value: THsJclDCC32);
begin
  FDCC := Value;
end;

procedure THsJclBorRADToolInstallation.SetOutputCallback(const Value: TTextHandler);
begin
...
procedure THsJclBorRADToolInstallation.SetRawDebugDCUPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckPlatform(APlatform);
  ConfigData.WriteString(DebuggingKeyName, DebugDCUPathValueName, Value);
end;

procedure THsJclBorRADToolInstallation.SetRawLibrarySearchPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckPlatform(APlatform);
  ConfigData.WriteString(LibraryKeyName, LibrarySearchPathValueName, Value);
end;

procedure THsJclBorRADToolInstallation.SetRawLibraryBrowsingPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckPlatform(APlatform);
  ConfigData.WriteString(LibraryKeyName, LibraryBrowsingPathValueName, Value);
end;

function THsJclBorRADToolInstallation.SubstitutePath(const Path: string): string;
var
  I: Integer;
  Name: string;
begin
...
function THsJclBorRADToolInstallation.SupportsVCL: Boolean;
const
  VclDcp = 'vcl.dcp';
begin
...
function THsJclBorRADToolInstallation.SupportsVisualCLX: Boolean;
const
...
function THsJclBorRADToolInstallation.UninstallBCBExpert(const ProjectName, OutputDir: string): Boolean;
var
  DllFileName: string;
begin
  ...
  if not IsBCBProject(ProjectName) then
    raise EHsJclBorRADException.CreateResFmt(@RsENotABCBProject, [ProjectName]);
...
function THsJclBorRADToolInstallation.UninstallBCBIdePackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
...
function THsJclBorRADToolInstallation.UninstallBCBPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
...
function THsJclBorRADToolInstallation.UninstallDelphiExpert(const ProjectName, OutputDir: string): Boolean;
var
  DllFileName: string;
begin
  OutputString(Format(LoadResString(@RsExpertUninstallationStarted), [ProjectName]));
...
function THsJclBorRADToolInstallation.UninstallDelphiIdePackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  MAPFileName,
...
function THsJclBorRADToolInstallation.UninstallDelphiPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
...
function THsJclBorRADToolInstallation.UninstallExpert(const ProjectName, OutputDir: string): Boolean;
var
  ProjectExtension: string;
begin
  ProjectExtension := ExtractFileExt(ProjectName);
...
function THsJclBorRADToolInstallation.UninstallIDEPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  PackageExtension: string;
begin
  PackageExtension := ExtractFileExt(PackageName);
...
function THsJclBorRADToolInstallation.UninstallPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
var
  PackageExtension: string;
begin
  PackageExtension := ExtractFileExt(PackageName);
...
function THsJclBorRADToolInstallation.UnregisterExpert(const ProjectName, OutputDir: string): Boolean;
begin
  Result := UnregisterExpert(BinaryFileName(OutputDir, ProjectName));
end;

function THsJclBorRADToolInstallation.UnregisterExpert(const BinaryFileName: string): Boolean;
begin
...
function THsJclBorRADToolInstallation.UnregisterIDEPackage(const PackageName, BPLPath: string): Boolean;
begin
  Result := UnregisterIDEPackage(BinaryFileName(BPLPath, PackageName));
end;

function THsJclBorRADToolInstallation.UnregisterIDEPackage(const BinaryFileName: string): Boolean;
begin
...
function THsJclBorRADToolInstallation.UnregisterPackage(const PackageName, BPLPath: string): Boolean;
begin
  Result := UnregisterPackage(BinaryFileName(BPLPath, PackageName));
end;

function THsJclBorRADToolInstallation.UnregisterPackage(const BinaryFileName: string): Boolean;
begin
...
//=== { THsJclBCBInstallation } ================================================

constructor THsJclBCBInstallation.Create(const AConfigDataLocation: string; ARootKey: Cardinal);
begin
...
destructor THsJclBCBInstallation.Destroy;
begin
  inherited Destroy;
end;

function THsJclBCBInstallation.GetEnvironmentVariables: TStrings;
begin
...
class function THsJclBCBInstallation.GetLatestUpdatePackForVersion(Version: Integer): Integer;
begin
  case Version of
    5:
      Result := 0;
...
class function THsJclBCBInstallation.PackageSourceFileExtension: string;
begin
  Result := SourceExtensionBCBPackage;
end;

class function THsJclBCBInstallation.ProjectSourceFileExtension: string;
begin
  Result := SourceExtensionBCBProject;
end;

class function THsJclBCBInstallation.RadToolKind: THsJclBorRADToolKind;
begin
  Result := brCppBuilder;
end;

function THsJclBCBInstallation.RADToolName: string;
begin
  Result := LoadResString(@RsBCBName);
end;

//=== { THsJclDelphiInstallation } =============================================

constructor THsJclDelphiInstallation.Create(const AConfigDataLocation: string; ARootKey: Cardinal);
begin
  inherited Create(AConfigDataLocation, ARootKey);
  FPersonalities := [bpDelphi32];
end;

destructor THsJclDelphiInstallation.Destroy;
begin
  inherited Destroy;
end;

function THsJclDelphiInstallation.GetEnvironmentVariables: TStrings;
begin
  Result := inherited GetEnvironmentVariables;
  if Assigned(Result) then
...
class function THsJclDelphiInstallation.GetLatestUpdatePackForVersion(Version: Integer): Integer;
begin
  case Version of
    5:
      Result := 1;
...
function THsJclDelphiInstallation.InstallPackage(const PackageName, BPLPath, DCPPath: string): Boolean;
begin
  Result := InstallDelphiPackage(PackageName, BPLPath, DCPPath);
end;

class function THsJclDelphiInstallation.PackageSourceFileExtension: string;
begin
  Result := SourceExtensionDelphiPackage;
end;

class function THsJclDelphiInstallation.ProjectSourceFileExtension: string;
begin
  Result := SourceExtensionDelphiProject;
end;

class function THsJclDelphiInstallation.RadToolKind: THsJclBorRADToolKind;
begin
  Result := brDelphi;
end;

function THsJclDelphiInstallation.RADToolName: string;
begin
  Result := LoadResString(@RsDelphiName);
end;

//=== { THsJclBDSInstallation } ==================================================

{$IFDEF MSWINDOWS}

constructor THsJclBDSInstallation.Create(const AConfigDataLocation: string; ARootKey: Cardinal = 0);
const
  PersonalitiesSection = 'Personalities';
begin
  inherited Create(AConfigDataLocation, ARootKey);
  FHelp2Manager := THsJclHelp2Manager.Create(IDEVersionNumber);
...
destructor THsJclBDSInstallation.Destroy;
begin
  FreeAndNil(FDCCIL);
  FreeAndNil(FDCC64);
  FreeAndNil(FBCC64);
...
function THsJclBDSInstallation.AddToCppBrowsingPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawCppPath: THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.AddToCppSearchPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawCppPath: THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.AddToCppLibraryPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawLibraryPath: THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.AddToCppIncludePath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawIncludePath: THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.CleanPackageCache(const BinaryFileName: string): Boolean;
var
...
function THsJclBDSInstallation.CompileDelphiDotNetProject(const ProjectName,
  OutputDir: string; PEFormat: THsJclBDSPlatform; const ExtraOptions: string): Boolean;
var
...
begin
  ...
  begin
    ...
    case PEFormat of
      ...
      bpWin64:
        if VersionNumber >= 3 then
          ...
          raise EHsJclBorRADException.CreateRes(@RsEWin64PlatformNotValid);
      bpOSX32:
        raise EHsJclBorRADException.CreateRes(@RsEOSXPlatformNotValid);
    else
      raise EHsJclBorRADException.CreateRes(@RsEPlatformNotValid);
    end;
    ...
    raise EHsJclBorRADException.CreateRes(@RsENoSupportedPersonality);
end;

function THsJclBDSInstallation.CompileDelphiPackage(const PackageName, BPLPath, DCPPath, ExtraOptions: string): Boolean;
var
  NewOptions: string;
begin
  ...
  begin
    if not (bpBCBuilder32 in Personalities) then
      raise EHsJclBorRADException.CreateResFmt(@RsEDualPackageNotSupported, [Name]);
...
function THsJclBDSInstallation.CompileDelphiProject(const ProjectName, OutputDir, DcpSearchPath: string): Boolean;
var
  ExtraOptions: string;
begin
...
function THsJclBDSInstallation.GetBDSPlatformStr(APlatform: THsJclBDSPlatform): string;
begin
  Result := '';
  case APlatform of
    bpWin32:
...
function THsJclBDSInstallation.GetBPLOutputPath(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetCommonProjectsDir: string;
begin
  Result := GetCommonProjectsDirectory(RootDir, IDEVersionNumber);
end;

class function THsJclBDSInstallation.GetCommonProjectsDirectory(const RootDir: string;
...
function THsJclBDSInstallation.GetCppPathsKeyName: string;
begin
  if IDEVersionNumber >= 5 then
...
function THsJclBDSInstallation.GetCppBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
  if IDEVersionNumber >= 5 then
    // use EnvOptions.proj
...
function THsJclBDSInstallation.GetCppSearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.GetCppLibraryPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
  if IDEVersionNumber >= 5 then
    // use EnvOptions.proj
...
function THsJclBDSInstallation.GetCppIncludePath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
  if IDEVersionNumber >= 5 then
    // use EnvOptions.proj
...
function THsJclBDSInstallation.GetDCC64: THsJclDCC64;
begin
  if not Assigned(FDCC64) then
  begin
    if not (clDcc64 in CommandLineTools) then
      raise EHsJclBorRADException.CreateResFmt(@RsENotFound, [Dcc64ExeName]);
    FDCC64 := THsJclDCC64.Create(BinFolderName, LongPathBug, DCCVersion, CompilerSettingsFormat,
...
function THsJclBDSInstallation.GetDCCOSX32: THsJclDCCOSX32;
begin
  if not Assigned(FDCCOSX32) then
  begin
    if not (clDccOSX32 in CommandLineTools) then
      raise EHsJclBorRADException.CreateResFmt(@RsENotFound, [DccOSX32ExeName]);
    FDCCOSX32 := THsJclDCCOSX32.Create(BinFolderName, LongPathBug, DCCVersion, CompilerSettingsFormat,
...
function THsJclBDSInstallation.GetBCC64: THsJclBCC64;
begin
  if not Assigned(FBCC64) then
  begin
    if not (clBcc64 in CommandLineTools) then
      raise EHsJclBorRADException.CreateResFmt(@RsENotFound, [Bcc64ExeName]);
    FBCC64 := THsJclBCC64.Create(BinFolderName, LongPathBug, CompilerSettingsFormat);
                               //SupportsNoConfig, SupportsPlatform, DCPOutputPath[bpWin64], LibFolderName[bpWin64],
                               //LibDebugFolderName[bpWin64], ObjFolderName[bpWin64]);
  end;
  Result := FBCC64;
...
function THsJclBDSInstallation.GetDCCIL: THsJclDCCIL;
begin
  if not Assigned(FDCCIL) then
  begin
    if not (clDccIL in CommandLineTools) then
      raise EHsJclBorRADException.CreateResFmt(@RsENotFound, [DccILExeName]);
    FDCCIL := THsJclDCCIL.Create(BinFolderName, LongPathBug, DCCVersion, CompilerSettingsFormat,
                               SupportsNoConfig, SupportsPlatform, DCPOutputPath[bpWin32], LibFolderName[bpWin32], LibDebugFolderName[bpWin32], ObjFolderName[bpWin32]);
  end;
  Result := FDCCIL;
end;

function THsJclBDSInstallation.GetDCPOutputPath(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetDebugDCUPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetDefaultProjectsDir: string;
begin
  Result := GetDefaultProjectsDirectory(RootDir, IDEVersionNumber);
end;

class function THsJclBDSInstallation.GetDefaultProjectsDirectory(const RootDir: string;
  IDEVersionNumber: Integer): string;
var
...
function THsJclBDSInstallation.GetEnvironmentVariables: TStrings;
var
...
class function THsJclBDSInstallation.GetLatestUpdatePackForVersion(Version: Integer): Integer;
begin
  case Version of
    9:
...
function THsJclBDSInstallation.GetLibDebugFolderName(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetLibFolderName(APlatform: THsJclBDSPlatform): string;
begin
  CheckPlatform(APlatform);
...
class procedure THsJclBDSInstallation.InterpretSetVariable(const Line: string; Variables: TStrings);
...
class procedure THsJclBDSInstallation.GetRADStudioVars(const RootDir: string; IDEVersionNumber: Integer; Variables: TStrings);
var
  Lines: TStrings;
  I: Integer;
begin
...
class function THsJclBDSInstallation.GetRADStudioVarsFileName(const RootDir: string; IDEVersionNumber: Integer): TFileName;
begin
  if IDEVersionNumber >= 5 then
    Result := Format('%s%sbin%srsvars.bat', [RootDir, DirDelimiter, DirDelimiter])
  else
    raise EHsJclBorRADException.CreateResFmt(@RsERsVars, [RadToolName(IDEVersionNumber), IDEVersionNumber, LoadResString(@RsMsBuildNotSupported)]);
end;

function THsJclBDSInstallation.GetValid: Boolean;
begin
...
function THsJclBDSInstallation.GetLibraryBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetLibrarySearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetMaxDelphiCLRVersion: string;
begin
  Result := DCCIL.MaxCLRVersion;
end;

function THsJclBDSInstallation.GetName: string;
begin
...
function THsJclBDSInstallation.GetMsBuildEnvironmentFileName: string;
begin
  Result := PathAddSeparator(ExtractFilePath(GetMsBuildEnvOptionsFileName)) + 'environment.proj';
end;

function THsJclBDSInstallation.GetMsBuildEnvOption(const OptionName: string; APlatform: THsJclBDSPlatform; Raw: Boolean): string;
var
  EnvOptions: THsJclMsBuildParser;
...
begin
  ...
  if FileExists(MsBuildEnvironmentFileName) then
    EnvOptions := THsJclMsBuildParser.Create(GetMsBuildEnvOptionsFileName, [MsBuildEnvironmentFileName])
  else
    EnvOptions := THsJclMsBuildParser.Create(GetMsBuildEnvOptionsFileName);
  try
    EnvOptions.Init;
...
function THsJclBDSInstallation.GetMsBuildEnvOptionsFileName: string;
var
...
begin
  ...
  begin
    ...
    raise EHsJclBorRADException.CreateRes(@RsMsBuildNotSupported);
end;

function THsJclBDSInstallation.GetRawCppBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.GetRawCppSearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.GetRawCppLibraryPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.GetRawCppIncludePath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.GetRawDebugDCUPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetRawLibraryBrowsingPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetRawLibrarySearchPath(APlatform: THsJclBDSPlatform): THsJclBorRADToolPath;
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.GetVclIncludeDir(APlatform: THsJclBDSPlatform): string;
begin
  CheckCBuilderPlatform(APlatform);
...
class function THsJclBDSInstallation.PackageSourceFileExtension: string;
begin
  Result := SourceExtensionDelphiPackage;
end;

class function THsJclBDSInstallation.ProjectSourceFileExtension: string;
begin
  Result := SourceExtensionDelphiProject;
end;

class function THsJclBDSInstallation.RadToolKind: THsJclBorRADToolKind;
begin
  Result := brBorlandDevStudio;
end;

class function THsJclBDSInstallation.RadToolName(
  IDEVersionNumber: Integer): string;
begin
  if IDEVersionNumber in [Low(BDSVersions)..High(BDSVersions)] then
...
function THsJclBDSInstallation.RadToolName: string;
begin
...
function THsJclBDSInstallation.RegisterPackage(const BinaryFileName, Description: string): Boolean;
begin
  if VersionNumber >= 3 then
...
function THsJclBDSInstallation.RemoveFromCppBrowsingPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawCppPath: THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.RemoveFromCppSearchPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawCppPath: THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.RemoveFromCppLibraryPath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawLibraryPath: THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
function THsJclBDSInstallation.RemoveFromCppIncludePath(const Path: string; APlatform: THsJclBDSPlatform): Boolean;
var
  TempRawIncludePath: THsJclBorRADToolPath;
begin
  CheckCBuilderPlatform(APlatform);
...
procedure THsJclBDSInstallation.SetDualPackageInstallation(const Value: Boolean);
begin
...
procedure THsJclBDSInstallation.SetMsBuildEnvOption(const OptionName, Value: string; APlatform: THsJclBDSPlatform);
var
...
begin
  ...
  EnvOptions := THsJclMsBuildParser.Create(EnvOptionsFileName);
  try
    EnvOptions.Init;
...
procedure THsJclBDSInstallation.SetOutputCallback(const Value: TTextHandler);
begin
...
procedure THsJclBDSInstallation.SetRawCppBrowsingPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckCBuilderPlatform(APlatform);
...
procedure THsJclBDSInstallation.SetRawCppSearchPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckCBuilderPlatform(APlatform);
  ConfigData.WriteString(GetCppPathsKeyName, CppSearchPathValueName, Value);
end;

procedure THsJclBDSInstallation.SetRawCppLibraryPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckCBuilderPlatform(APlatform);
...
procedure THsJclBDSInstallation.SetRawCppIncludePath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckCBuilderPlatform(APlatform);
...
procedure THsJclBDSInstallation.SetRawDebugDCUPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckPlatform(APlatform);
...
procedure THsJclBDSInstallation.SetRawLibraryBrowsingPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckPlatform(APlatform);
...
procedure THsJclBDSInstallation.SetRawLibrarySearchPath(APlatform: THsJclBDSPlatform; const Value: THsJclBorRADToolPath);
begin
  CheckPlatform(APlatform);
...
function THsJclBDSInstallation.UnregisterPackage(const BinaryFileName: string): Boolean;
begin
...
//=== { THsJclBorRADToolInstallations } ========================================

constructor THsJclBorRADToolInstallations.Create;
begin
  FList := TObjectList.Create;
  ReadInstallations;
end;

destructor THsJclBorRADToolInstallations.Destroy;
begin
  FreeAndNil(FList);
  inherited Destroy;
end;

function THsJclBorRADToolInstallations.AnyInstanceRunning: Boolean;
var
  I: Integer;
begin
  Result := False;
...
function THsJclBorRADToolInstallations.AnyUpdatePackNeeded(var Text: string): Boolean;
var
  I: Integer;
begin
  Result := False;
...
function THsJclBorRADToolInstallations.GetCount: Integer;
begin
  Result := FList.Count;
end;

function THsJclBorRADToolInstallations.GetBCBInstallationFromVersion(VersionNumber: Integer): THsJclBorRADToolInstallation;
var
  I: Integer;
begin
  Result := nil;
...
function THsJclBorRADToolInstallations.GetDelphiInstallationFromVersion(
  VersionNumber: Integer): THsJclBorRADToolInstallation;
var
  I: Integer;
begin
  Result := nil;
...
function THsJclBorRADToolInstallations.GetInstallations(Index: Integer): THsJclBorRADToolInstallation;
begin
  Result := THsJclBorRADToolInstallation(FList[Index]);
end;

function THsJclBorRADToolInstallations.GetBCBVersionInstalled(VersionNumber: Integer): Boolean;
begin
  Result := BCBInstallationFromVersion[VersionNumber] <> nil;
end;

function THsJclBorRADToolInstallations.GetBDSInstallationFromVersion(VersionNumber: Integer): THsJclBorRADToolInstallation;
var
  I: Integer;
begin
  Result := nil;
...
function THsJclBorRADToolInstallations.GetBDSVersionInstalled(VersionNumber: Integer): Boolean;
begin
  Result := BDSInstallationFromVersion[VersionNumber] <> nil;
end;

function THsJclBorRADToolInstallations.GetDelphiVersionInstalled(VersionNumber: Integer): Boolean;
begin
  Result := DelphiInstallationFromVersion[VersionNumber] <> nil;
end;

function THsJclBorRADToolInstallations.Iterate(TraverseMethod: TTraverseMethod): Boolean;
var
  I: Integer;
begin
  Result := True;
...
begin
  ...
  try
    EnumVersions(DelphiKeyName, [], THsJclDelphiInstallation);
    EnumVersions(BCBKeyName, [], THsJclBCBInstallation);
    EnumVersions(BDSKeyName, ['Delphi.Win32', 'BCB', 'Delphi8', 'C#Builder'], THsJclBDSInstallation);
    EnumVersions(CDSKeyName, ['Delphi.Win32', 'BCB', 'Delphi8', 'C#Builder'], THsJclBDSInstallation);
    EnumVersions(EDSKeyName, ['Delphi.Win32', 'BCB', 'Delphi8', 'C#Builder'], THsJclBDSInstallation);
  finally
    VersionNumbers.Free;
  end;
end;
